        ...
        <div className="flex flex-1 items-center justify-center">
          <div className="text-center text-muted-foreground">
            ...
            <h2 className="mb-1 text-lg font-semibold text-foreground">
              {t('mainContent.loadingSessionsTitle')}
            </h2>
            <p className="text-sm">{t('mainContent.loadingSessionsDescription')}</p>
          </div>
        </div>
      ) : (
        <div className="flex flex-1 items-center justify-center">
          <div className="mx-auto max-w-md px-6 text-center">
            ...
            <h2 className="mb-2 text-xl font-semibold text-foreground">
              {t('mainContent.sessionHubTitle')}
            </h2>
            <p className="mb-5 text-sm leading-relaxed text-muted-foreground">
              {t('mainContent.sessionHubDescription')}
            </p>
            <div className="rounded-xl border border-primary/10 bg-primary/5 p-3.5">
              <p className="text-sm text-primary">
                <strong>{t('mainContent.tip')}:</strong> {t('mainContent.sessionHubTip')}
              </p>
            </div>
          </div>
        </div>
