...
import { getStoredClaudeSettings, getStoredCodexSettings } from '../../../shared/providerSettings';
...
export default function Onboarding({ onComplete }: OnboardingProps) {
  ...
  const isCurrentStepValid = currentStep === 0
    ...
    : true;
  const loginCommand = activeLoginProvider === 'codex'
    ? getStoredCodexSettings().command
    : activeLoginProvider === 'claude'
      ? getStoredClaudeSettings().command
      : '';
